...
class LoginUseCase:
    ...
    whose impl (in member.repositories) knows how member credentials are
    actually stored. The auth module doesn't import MemberRepository or
    PasswordHasher directly — keeps the auth use cases free of
    member-model leaks.
    """
