...
class TestPyJWTTokenIssuer:
    """Auth's TokenIssuer is scoped to access + refresh tokens only.
    Verification tokens live in member.repositories.PyJWTVerificationTokenIssuer
    (see tests/member/repositories/test_pyjwt_verification_token_issuer.py)."""
