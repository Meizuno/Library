...
See tests/book/infrastructure/test_sql_soft_delete.py for the rationale —
...
from library.member.domain import Member, MemberNotFound
from library.member.infrastructure import SqlMemberRepository
