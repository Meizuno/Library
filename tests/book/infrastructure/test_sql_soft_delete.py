...
The parametrized contract suite in test_repository.py verifies the
...
In-memory backends are excluded by design: they hard-delete, and the
contract is observable equivalence, not implementation equivalence.
"""
...
from library.book.domain import Book, BookNotFound
